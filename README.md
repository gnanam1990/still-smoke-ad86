...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/still-smoke-ad86)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/still-smoke-ad86
```

A live public deployment of this template is available at [https://still-smoke-ad86.templates.workers.dev](https://still-smoke-ad86.templates.workers.dev)
